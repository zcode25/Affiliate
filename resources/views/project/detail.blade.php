          ...
          <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6">
              ...
              <form action="{{ route('project.update', $project) }}" method="POST" class="mt-6">
                  ...
                  <div class="mb-4">
                    ...
                    <x-text-input id="total_value" class="block mt-1 w-full" type="text" name="total_value" :value="old('total_value',  $project->total_value)" placeholder="Enter total value" autofocus autocomplete="total_value" />
                    <x-input-error :messages="$errors->get('total_value')" class="mt-2" />
                  </div>
                  <div class="mb-5">
                    <label for="status" class="block mb-1 font-medium text-sm text-gray-700 dark:text-gray-300">Status</label>
                    <select id="status" name="status" class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-indigo-500 dark:focus:border-indigo-500">
